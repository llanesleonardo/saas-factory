...
- **`factory/02_workforce/02_00_agents/context-packs/docs.json`** · **`factory/02_workforce/02_00_agents/agent-registry.json`** (`docs`)
...
See **`factory/02_workforce/02_00_agents/agent-registry.json`** → **`references.qms_ivv_procedures`**.
