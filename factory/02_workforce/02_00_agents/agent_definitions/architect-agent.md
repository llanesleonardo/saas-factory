...
- Problem statement / ADR draft; optional **`configs/apps/<vertical>/specs/<vertical>-spec.md`** NFR section.
...
- **`factory/02_workforce/02_00_agents/context-packs/architect.json`** · **`factory/02_workforce/02_00_agents/agent-registry.json`** (`architect`)
...
When defining **`packages/*`** vs **`apps/*`** boundaries, align verification expectations with **`organizational_memory/QMS/published/QMS-PUB-003-subsystem-verification-plan.md`** (subsystem acceptance). Registry: **`factory/02_workforce/02_00_agents/agent-registry.json`** → **`references.qms_ivv_procedures`**.
...
- Align with repo truth: **`apps/core-saas/`**, **`apps/<vertical>-instance/`**, **`packages/*`**, **`configs/apps/<vertical>/<vertical>.json`** (**`organizational_memory/ARCHITECTURE.md`**).
...
| **`configs/apps/<vertical>/<vertical>.json`** | Inputs to **spec generation** and metadata—not a substitute for runnable instance code unless an ADR introduces a true config runtime |
...
**Vertical modeling:** start from **`configs/apps/<vertical>/specs/<vertical>-spec.md`** and **`configs/apps/<vertical>/<vertical>.json`**; use **`@agents/spec-generator-agent.md`** when the narrative needs refreshing.
