...
- **Tooling**
  - Task-queue validation (`npm run validate-task-queue`); factory planning scripts; optional **Mermaid diagrams-as-code** skill (`.cursor/skills/mermaid-diagrams/`) for specs and `factory/06_knowledge_base/`
...
Aligned with the factory process figure (`factory/06_knowledge_base/master_reviews/mermaid-diagram.png`): three bands — **Planning & Specification**, **Execution Pipeline**, **Organizational Memory**.
...
### Architecture memo
- `factory/06_knowledge_base/architecture_reviews/architecture-review-001-2026-05-08.md`
- `factory/06_knowledge_base/architecture_reviews/architecture-review-002-2026-05-08.md` (post–Phase 6; Phase 7 boundaries)
- `factory/06_knowledge_base/architecture_reviews/architecture-review-003-2026-05-08-phase7-ui-stack.md` (Phase 7: Tailwind + Headless UI)

### QMS inbox records (partial list; see `factory/06_knowledge_base/qms_docs/inbox/` for full set)
- `factory/06_knowledge_base/qms_docs/inbox/2026-05-08-spec-generator-todo-spec.md`
- `factory/06_knowledge_base/qms_docs/inbox/2026-05-08-builder-todo-instance-scaffold.md`
- `factory/06_knowledge_base/qms_docs/inbox/2026-05-08-dev-TODO_001_storage_model.md`
- `factory/06_knowledge_base/qms_docs/inbox/2026-05-08-dev-TODO_002_ui_crud_wiring.md`
- `factory/06_knowledge_base/qms_docs/inbox/2026-05-08-dev-TODO_003_basic_accessibility.md`
- `factory/06_knowledge_base/qms_docs/inbox/2026-05-08-quality-TODO_001_storage_model.md`
- `factory/06_knowledge_base/qms_docs/inbox/2026-05-08-quality-TODO_002_ui_crud_wiring.md`
- `factory/06_knowledge_base/qms_docs/inbox/2026-05-08-quality-TODO_003_basic_accessibility.md`
- `factory/06_knowledge_base/qms_docs/inbox/2026-05-08-quality-TODO_008_quality_phase2_gates.md`
- `factory/06_knowledge_base/qms_docs/inbox/2026-05-08-fix-todo-instance-vitest-happy-dom.md`
- `factory/06_knowledge_base/qms_docs/inbox/2026-05-08-docs-node-pin-and-vitest-env-loop.md`
- `factory/06_knowledge_base/qms_docs/inbox/2026-05-08-docs-todo-phase3-loop.md`
- `factory/06_knowledge_base/qms_docs/inbox/2026-05-08-docs-post-merge-closure-todo-phase2.md`
- `factory/06_knowledge_base/qms_docs/inbox/2026-05-08-docs-pr-importance.md`

### Lessons learned register
- `factory/06_knowledge_base/qms_docs/LESSONS-LEARNED.md`
...
- **`main`:** todo-instance tasks **`TODO_001` through `TODO_032` are all `status: "done"`** in `factory/task-queue.json` (Phases 2–6). Post-merge closure is recorded in `factory/06_knowledge_base/qms_docs/inbox/2026-05-08-docs-post-merge-closure-phase6-task-queue-complete.md` (QMS-PUB-005 loop).
