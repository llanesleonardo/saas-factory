...
- `factory/06_knowledge_base/routing/AGENTS.md` — Support → PM / Spec Generator routing
- `factory/06_knowledge_base/architecture/ARCHITECTURE.md` — integration modes and contracts
