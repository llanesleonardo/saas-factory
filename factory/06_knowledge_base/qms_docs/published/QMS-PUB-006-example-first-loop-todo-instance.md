...
| **Source records** | `factory/06_knowledge_base/qms_docs/inbox/2026-05-08-builder-todo-instance-scaffold.md`, `.../2026-05-08-spec-generator-todo-spec.md`, `.../2026-05-08-dev-TODO_001_storage_model.md`, `.../2026-05-08-quality-TODO_001_storage_model.md`, `.../2026-05-09-fix-ci-todoapp-api-jest-types.md`, `.../2026-05-09-fix-ci-todoapp-instance-jsx.md` |
...
- `factory/06_knowledge_base/process/FACTORY-PROCESS.md` (end-to-end flow)
- `factory/06_knowledge_base/routing/AGENTS.md` (router + message templates)
- `factory/06_knowledge_base/qms_docs/published/QMS-PUB-005-pull-request-decision-gate.md` (PR gate + post-merge closure)
...
- `configs/apps/todo/todo.json` (vertical metadata)
...
Create configs/apps/todo/specs/todo-spec.md for MVP (add/list/complete/delete).
...
Input spec: @configs/apps/todo/specs/todo-spec.md.
Produce ≤2h tasks with ids, depends_on, acceptance_criteria.
Output JSON suitable for factory/03_assembly_lines/03-registry/registry/task-queue.json.
```

**Expected artifacts**:
- Tasks recorded in `factory/03_assembly_lines/03-registry/registry/task-queue.json` (or pasted output ready to be recorded)
...
Task id: <ID>
Implement only this task in apps/todo-instance/ per configs/apps/todo/specs/todo-spec.md.
```
