...
**In scope:** boundaries per `factory/06_knowledge_base/architecture/ARCHITECTURE.md`, contracts across monorepo-integrated vs HTTP-integrated modes, and targeted tests or checks at package/app granularity.
...
- `factory/06_knowledge_base/architecture/ARCHITECTURE.md` — integration modes, env var contracts
