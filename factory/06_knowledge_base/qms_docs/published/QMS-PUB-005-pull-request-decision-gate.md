...
| **Source records** | `factory/06_knowledge_base/qms_docs/inbox/2026-05-08-docs-pr-importance.md` |
...
- `factory/06_knowledge_base/routing/AGENTS.md` — role router + why PRs matter
- `factory/06_knowledge_base/qms_docs/published/QMS-PUB-002-system-verification-plan.md` — system verification expectations (CI + Quality)
