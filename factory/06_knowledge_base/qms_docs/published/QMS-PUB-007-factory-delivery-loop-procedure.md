...
| **Status** | Draft |
| **Owner (role)** | Docs |
| **Source records** | `factory/06_knowledge_base/qms_docs/inbox/2026-05-09-tooling-factory-platform-hardening.md`, `factory/06_knowledge_base/qms_docs/inbox/2026-05-09-docs-first-loop-standard-work.md`, `factory/06_knowledge_base/qms_docs/inbox/2026-05-09-docs-qms-pub-005-close-loop.md` |
...
- Router and role entry points: `factory/06_knowledge_base/routing/AGENTS.md`
- End-to-end walkthrough: `factory/06_knowledge_base/process/FACTORY-PROCESS.md`
- Canonical work inventory: `factory/task-queue.json`
- Planner / next-task suggestion: `npm run factory:next`
- Parallel waves (optional): compute with `computeParallelBatches` in `factory/factory_libs/planning/task-graph.ts` (no standalone CLI).
- QMS inbox record template: `agents/agent-record-for-qms.md`
- Decision gate: `factory/06_knowledge_base/qms_docs/published/QMS-PUB-005-pull-request-decision-gate.md`
...
2. Substantive work has a QMS inbox record under `factory/06_knowledge_base/qms_docs/inbox/` per `agents/agent-record-for-qms.md`.
