...
- **Related inbox records (optional):** `factory/06_knowledge_base/qms_docs/inbox/2026-05-09-dev-TODO_006_storage_adapter_tests.md`

## Actions performed

- Executed verification gates for TODO_006 on `apps/todo-instance/` (tests + build + lint).
