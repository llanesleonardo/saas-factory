...
- optional shared services under `apps/core-saas/` or `packages/*` as defined by `factory/06_knowledge_base/architecture/ARCHITECTURE.md`
...
- **Decision gate**
  - A PR decision gate equivalent must exist for staging/prod (see `factory/06_knowledge_base/qms_docs/published/QMS-PUB-005-pull-request-decision-gate.md`).
