...
- Link ADRs from the docs they constrain (e.g. `factory/06_knowledge_base/architecture/ARCHITECTURE.md`, `factory/06_knowledge_base/process/FACTORY-PROCESS.md`).
- If a decision introduces a new contract, pair it with a **machine-checkable artifact** under `factory/factory_schemas/` or a validator under `factory/`.
