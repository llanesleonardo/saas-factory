...
function validateCompanionJson(filePath: string, data: unknown): string[] {
  ...
  if (!Array.isArray(data.evidence_paths) || !isStringArray(data.evidence_paths) || data.evidence_paths.length === 0) {
...
async function main(): Promise<void> {
  ...
  const inboxDir = dirArg
    ...
    : queueDirArg
      ...
      : path.resolve(__dirname, "..", "..", "..", "..", "factory", "06_knowledge_base", "qms_docs", "inbox");
