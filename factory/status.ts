...
import { loadTaskQueue, normalizeTaskStatus, type FactoryTask, type TaskStatus } from "./task-graph.js";
...
async function main(): Promise<void> {
  ...
  const summary = summarize(queuePath ?? "factory/task-queue.json", tasks);
