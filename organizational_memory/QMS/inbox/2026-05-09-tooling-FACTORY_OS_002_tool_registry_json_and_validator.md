...
- **Spec / PR refs:** `organizational_memory/factory-os-tool-registry-spec.md`, `factory/tool-registry.json`, `factory/validate-tool-registry.ts`, `.github/workflows/factory-parallel-ci.yml`
...
- Added a JSON Schema (`factory/schemas/tool-registry.schema.json`) for the registry shape.
