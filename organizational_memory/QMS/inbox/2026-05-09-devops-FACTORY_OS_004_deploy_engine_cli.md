...
- **Spec / PR refs:** `organizational_memory/factory-os-deploy-engine-spec.md`, `factory/deploy.ts`, `package.json`, `factory/tool-registry.json`
- **Depends on (optional):** FACTORY_OS_003_deploy_engine_spec
- **Related inbox records (optional):** `organizational_memory/QMS/inbox/2026-05-09-spec-generator-FACTORY_OS_003_deploy_engine_spec.md`
