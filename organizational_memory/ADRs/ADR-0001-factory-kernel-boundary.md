...
## Context
The factory has multiple “sources of truth” for how work moves: code under `factory/*`, doctrine under `organizational_memory/*`, and role prompts under `agents/*`. Agents execute fast; ambiguity creates drift fast.
...
- **Doctrine & governance (docs)**: `organizational_memory/*`
...
- **Follow-ups**:
  - add `factory/schemas/task-queue.schema.json`
...
- `organizational_memory/FACTORY-PROCESS.md`
